...
int display()
{
		...
		cout<<"\nTotal products in our Pharmacy store is : "<<c<<"\n\n\n";
		return c;
	    }
////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////
	void buy()
	{
		...
		cout<<"\n<<<<<<<<<This medicine/product is not available in our store at this time>>>>\n\n";
 ...
 /////////////////////////////////////////////////////////////////////////////////////////
	...
	cout<<"\t\t============================================"<<endl;
	cout<<"\t\t|          	Pharmacist Portal            |"<<endl;
	cout<<"\t\t============================================"<<endl;

	cout<<"\t\t     Enter 1 For Adding a new product/Medicine    "<<endl;
	cout<<"\t\t     Enter 2 For Displaying all products/Medicine   "<<endl;
	cout<<"\t\t     Enter 3 For MODIFYING Existing product/Medicine"<<endl;
	cout<<"\t\t     Enter 4 For Deleting a particular product/Medicine"<<endl;
...
int main()
{
	...
	cout<<"--------------------------------------------------------"<<endl;
   	gotoxy(17,11);
   	cout<<"|Subject Teacher ->> Dr. Ajitkumar S. Shitole <<-- |\n"<<endl;
   	gotoxy(17,13);
    ...
    gotoxy(22,15);
   	...
   	gotoxy(22,17);
   	cout<<"                      PRATHAMESH BHISE (SC44)"<<endl<<endl;
	system("pause");
	system("cls");
	system("color Fc"); 
    ...
    cout<<"\n\t\t|--------<Main Menu>-----------|";
      cout<<"\n\n";
	cout<<"\t\t 1)Administator of Pharmacy\n";
	cout<<"\t\t 2)Customer               \n";
	cout<<"\t\t 3)Exit                    \n";
